...
namespace PrimeAssault.Services
{
    public class MockDataStore : IDataStore<ItemModel>
    {
        ...
        /// <param name="id"></param>
        /// <returns>True for pass, else fail</returns>
        public async Task<bool> CharacterDeleteAsync(string id)
        {
        ...
        /// <param name="id"></param>
        /// <returns>Record if found else null</returns>
        public async Task<PlayerCharacterModel> CharacterReadAsync(string id)
        {
        ...
        /// <param name="forceRefresh"></param>
        /// <returns></returns>
        public async Task<IEnumerable<PlayerCharacterModel>> CharacterIndexAsync(bool forceRefresh = false)
        {
